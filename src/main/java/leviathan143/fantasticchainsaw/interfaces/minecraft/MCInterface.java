...
public class MCInterface
{
    ...
    {
	return new MCResourceRepositoryAggregate(defaults);//return PROJECT_TO_RESOURCE_AGGREGATE.computeIfAbsent(project, proj -> new MCResourceRepositoryAggregate(defaults));
    }
    ...
    public static JSONModel getJavaRepresentation(MCResourceRepositoryAggregate repoAggregate, Path path) throws IOException
    {
