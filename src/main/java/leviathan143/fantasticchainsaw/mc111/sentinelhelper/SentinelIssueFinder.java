...
public class SentinelIssueFinder extends ASTDependentTool
{
	...
	for (Entry<ASTNode, String> nodeNodeNamePair : (List<Entry<ASTNode, String>>) issues.get(IssueType.NULL_PARAMETER))
	{
	    MarkerHelper.createSentinelIssueMarker(baseResource, String.format(
	...
	public boolean visit(MethodInvocation node)
	{
	    ...
	    /*Some methods, such as {@code Enum#valueOf()} don't have a java element attached for some reason.
	     These methods can't be analysed.*/
