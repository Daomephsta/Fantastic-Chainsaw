...
public class ForgeBuildPathPage extends NewJavaProjectWizardPageTwo
{
	...
	{
		IClasspathEntry[] forgeDefaultEntries = new IClasspathEntry[]{JavaCore.newSourceEntry(jproject.getPath()
				.append("src/main/java")), JavaCore.newSourceEntry(jproject.getPath().append("src/main/resources"))};
